...
*/
export declare type ElementType = "taggedValueSpecification" | "stereotypeExtension" | "class" | "stereotype" | "property" | "package" | "profile" | "dataType" | "primitiveType" | "parameter" | "operation" | "model" | "literalUnlimitedNatural" | "literalString" | "literalReal" | "literalNull" | "literalInteger" | "literalBoolean" | "interfaceRealization" | "interface" | "generalization" | "enumerationLiteral" | "enumeration" | "documentReference" | "document" | "comment" | "association";
/**
* VisibilityKind is an enumeration type that defines literals to determine the visibility of Elements
* in a model.
*/
export declare type VisibilityKind = 'public' | 'private' | 'protected' | 'package';
/**
...
* parameters.
*/
export declare type ParameterDirectionKind = 'in' | 'inout' | 'out' | 'return';
/**
...
export declare type DocumentLocationKind = 'local' | 'npm';
...
*/
export declare type AggregationKind = 'none' | 'shared' | 'composite';
/**
