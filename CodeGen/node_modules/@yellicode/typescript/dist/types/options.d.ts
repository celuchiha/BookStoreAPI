 ...
 */
export declare enum OptionalityModifier {
    /**
...
export declare enum EnumFeatures {
    None = 0,
    JsDocDescription = 1,
    Initializers = 2,
    All = 3
...
export declare enum ClassFeatures {
    None = 0,
    JsDocDescription = 1,
    Generalizations = 2,
    InterfaceRealizations = 4,
    All = 7
}
...
export declare enum InterfaceFeatures {
    None = 0,
    JsDocDescription = 1,
    Generalizations = 2,
    All = 3
...
export declare enum PropertyFeatures {
    None = 0,
    JsDocDescription = 1,
    AccessModifier = 2,
    ReadonlyModifier = 4,
...
export declare enum FunctionFeatures {
    None = 0,
    JsDocDescription = 1,
    AccessModifier = 2,
    OptionalModifier = 4,
...
export declare enum ParameterFeatures {
    None = 0,
    JsDocDescription = 1,
    OptionalModifier = 2,
    All = 3
